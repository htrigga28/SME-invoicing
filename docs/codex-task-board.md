...
| T005 Customer management | In Progress | `task/T005-customer-management` | TBD | Build customer create, list, detail, edit, and archive flows within an organisation. | Customer API, UI, seed data, tenant isolation, RBAC, soft archive, and duplicate active email rules are being implemented. |
