...
| T003 Auth, automatic organisation creation, RBAC foundation, and business onboarding | In Progress | `task/T003-auth-onboarding` | TBD | Implement registration, login, automatic organisation/workspace creation, owner membership, RBAC foundation, and business profile onboarding. | This branch implements auth/session foundation, Drizzle tables/migrations, RBAC/tenant guards, and business profile onboarding. |
