...
| T003 Auth, automatic organisation creation, RBAC foundation, and business onboarding | In Review | `task/T003-auth-onboarding` | [#2](https://github.com/htrigga28/SME-invoicing/pull/2) | Implement registration, login, automatic organisation/workspace creation, owner membership, RBAC foundation, and business profile onboarding. | Auth/session foundation, Drizzle tables/migrations, RBAC/tenant guards, and business profile onboarding are implemented; validation passes. |
