...
| T013 Payments and Reconciliation Page | In Progress | `codex/T013-payments-reconciliation` | TBD | Build internal payments and reconciliation views showing payment references, invoice matches, and reconciliation status. | Users can see paid, partial, unpaid, failed, and overdue states clearly with subaccount-aware payment records. |
