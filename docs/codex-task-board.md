...
| T008 Paystack payment initialization | In Review | `task/T008-paystack-initialization` | [#7](https://github.com/htrigga28/SME-invoicing/pull/7) | Initialize Paystack test payments from public invoice pages and store pending payment records. | Customers can start a test payment and receive a valid Paystack checkout flow. |
