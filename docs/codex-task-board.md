...
| T002 Repository and tooling foundation | Not Started | `task/T002-repo-tooling` | TBD | Initialize monorepo tooling, package manager scripts, formatting, linting, typechecking, testing, and base CI. | Tooling commands exist and validation can run consistently. |
