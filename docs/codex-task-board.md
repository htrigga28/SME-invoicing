...
| T007 Public invoice page | In Review | `task/T007-public-invoice-page` | [#6](https://github.com/htrigga28/SME-invoicing/pull/6) | Add public invoice link/page showing business, customer, line items, totals, status, and payment call to action. | Customers can view a public invoice without accessing private app data. |
