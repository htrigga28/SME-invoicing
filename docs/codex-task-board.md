...
| T009 Paystack webhook processing | In Progress | `task/T009-paystack-webhooks` | TBD | Verify Paystack webhook signatures, process payment events idempotently, update payment records, and update invoice statuses. | Successful Paystack events safely reconcile to invoices without duplicate processing. |
