...
| T022 Recurring Billing, Scheduled Sends and Reminder Automation | In Progress | `feat/t022-recurring-reminder-automation` | TBD | Add recurring invoice schedules, date-based scheduled sends, organisation reminder sequences, customer/invoice reminder suppression, and a Postgres-backed automation job ledger driven by one protected daily Vercel Cron invocation. | Recurring invoices and reminders execute idempotently without duplicate invoices/emails, reuse T021 Resend communications, respect payment truth, and expose clear pause/resume/failure states in the Lumina workspace. |
