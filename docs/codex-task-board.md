...
| T006 Invoice core | In Review | `task/T006-invoice-core` | [#5](https://github.com/htrigga28/SME-invoicing/pull/5) | Implement invoice creation, line items, invoice details, status rules, totals, and audit events. | Users can create, view, edit draft, send, cancel, and void invoices with server-calculated totals, organisation-scoped numbers, and status events. |
