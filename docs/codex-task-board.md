...
| T002 Repository and tooling foundation | Done | `task/T002-repo-tooling` | TBD | Initialize monorepo tooling, package manager scripts, formatting, linting, typechecking, testing, and base CI. | Monorepo, frontend/API shells, shared package, validation scripts, CI, and README are in place; validation passes. |
