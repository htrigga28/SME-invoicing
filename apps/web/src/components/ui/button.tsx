...
const variantClassNames: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[var(--accent-border)] bg-[var(--accent-muted)] text-[var(--accent)] hover:border-[var(--accent-border-strong)] hover:bg-[var(--accent-muted)]",
  outline:
    "border border-[var(--border-default)] bg-[var(--surface)] text-[var(--text-primary)] hover:border-[var(--border-strong)] hover:bg-[var(--surface-raised)]",
  ghost:
    "bg-transparent text-[var(--text-secondary)] hover:bg-[var(--surface-raised)] hover:text-[var(--text-primary)]",
  destructive:
    "border border-[var(--danger-border)] bg-[var(--surface)] text-[var(--danger)] hover:bg-[var(--danger-muted)]"
};
